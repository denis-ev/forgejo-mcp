...
func registerCommands(s *mcp.Server, cl *tools.Client) {
	...
	tools.Register(s, &pullreq.GetPullRequestFilesImpl{Client: cl})
	tools.Register(s, &pullreq.GetPullRequestDiffImpl{Client: cl})
	...
	tools.Register(s, &repo.GetFileContentsImpl{Client: cl})
	tools.Register(s, &repo.ListCommitsImpl{Client: cl})
	tools.Register(s, &repo.GetCommitImpl{Client: cl})
	tools.Register(s, &repo.ListBranchesImpl{Client: cl})
	...
	tools.Register(s, &action.ListActionRunsImpl{Client: cl})
	tools.Register(s, &action.GetActionRunImpl{Client: cl})
